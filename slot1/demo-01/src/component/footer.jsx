    ...
    return (
        ...
        <Container fluid>
            <Row className="align-items-center">
                <Col xs={2}>
                    <Image src="/images/a.jpg" alt="Author Avatar" className="rounded-circle" style={{ width: '60px', height: '60px', objectFit: 'cover' }} />
                </Col>
                <Col xs={8}>
                    <h5>Tác giả: &copy; TranTheLuong</h5>
                    <small>All rights reserved.</small>
                </Col>
                <Col xs={2}>
                    <a href="luongttde180077@fpt.edu.vn">luongttde180077@fpt.edu.vn</a>    
                </Col>
            </Row>
        </Container>
        </footer>
